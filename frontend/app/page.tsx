    ...
    <div style={{ minHeight: "100vh", background: "#f5f0e8", padding: "60px 20px", fontFamily: "'DM Sans', sans-serif" }} className="animate-fade-in">
      <div style={{ maxWidth: "1000px", margin: "0 auto" }}>
        ...
        <div style={{ marginBottom: "80px" }}>
          <h1 style={{ fontSize: "14px", fontWeight: "600", color: "#a8d5a2", textTransform: "uppercase", letterSpacing: "0.1em", margin: "0 0 60px 0" }}>
            NIO
          </h1>

          <h2 style={{ fontSize: "56px", fontWeight: "700", lineHeight: "1.2", margin: "0 0 24px 0", color: "#1a1a1a", maxWidth: "700px" }}>
            Put Your Outreach on Autopilot
          </h2>
          <p style={{ fontSize: "18px", color: "#666", margin: "0 0 40px 0", maxWidth: "600px", lineHeight: "1.7" }}>
        ...
        <div style={{ marginTop: "120px" }}>
          <h3 style={{ fontSize: "12px", fontWeight: "600", color: "#666", textTransform: "uppercase", letterSpacing: "0.08em", margin: "0 0 40px 0" }}>
            How it works
          </h3>
